  ...
  return (
    <div className="space-y-4">
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-300 rounded-lg text-sm font-semibold bg-white hover:bg-slate-50 transition disabled:opacity-50"
      >
