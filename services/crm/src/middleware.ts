...
export const config = {
  // Exclude Next internals, favicon, AND any path with a static asset
  // extension so that /public/* files (logos etc.) are reachable on the
  // login page even before the user authenticates.
  matcher: [
