...
import { LayoutGrid, Newspaper, BookOpen, Users, Settings, LogOut } from "lucide-react";

const navigation = [
  { name: "Startseite", href: "/", icon: LayoutGrid },
  { name: "News", href: "/news", icon: Newspaper },
  { name: "Wissen", href: "/wiki", icon: BookOpen },
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-primary text-white flex flex-col">
      <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
        ...
        <img src="/kfzblitz-logo.svg" alt="kfzblitz24" className="h-7 w-auto" />
